---
name: ankyr-nodejs
description: TypeScript and JavaScript syntax, typing, and tooling discipline — no any, no suppression, async/await, lint hygiene. Use when writing or reviewing .ts/.tsx/.js files.
