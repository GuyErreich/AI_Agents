---
name: ankyr-improvement-protocol
...
**Canonical location:** this plugin's `skills/ankyr-improvement-protocol/SKILL.md` ([GuyErreich/AI_Agents](https://github.com/GuyErreich/AI_Agents)) — do not duplicate per project.
...
|---|---|
| Generic web UX / layout pattern | `ankyr-web` plugin `skills/ankyr-ux/references/` |
