...
description: Agent-library hierarchy — when to add a rule, SKILL.md, reference, or asset; link depth vs folder depth; prefer deepening over widening. Use when creating or reorganizing skills, rules, or AGENT.md under .cursor/ or the agent stack. Extends hierarchy.
...
Load `skills/hierarchy/SKILL.md` first. Nesting and retrieval tests apply; this skill adds **container tiers** and agent-specific aggregation.
