...
Activate for GSAP, Framer Motion, timelines, scrubbers, VFX galleries, curation carousels, showreel-like controls. Pair with `react` (`gsap-patterns`), `ux`, and project `AGENT.md`.
