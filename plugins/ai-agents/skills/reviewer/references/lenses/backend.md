...
Activate when Supabase, SQL, migrations, edge functions, RLS, auth, API routes, or secrets/env change. Load `project/platform/supabase` and `security` when present.
