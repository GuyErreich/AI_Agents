...
- Focus ring styling, tap highlight, and active press feedback: `ux` → `references/shared/press-feedback.md`.

Project-specific motion and sound wiring (when repo adopts generative sound) is documented in nearest `AGENT.md` and `ux` → `generative-sound.md`.
