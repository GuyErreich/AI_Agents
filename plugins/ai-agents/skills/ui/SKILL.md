...
Load `skills/engineering/SKILL.md` first, then `skills/nodejs/SKILL.md` for `.tsx` files. Add UI-specific rules only.
...
- **UX is separate.** Load `skills/ux/SKILL.md` when adding or editing interactive **behavior** — press feedback, motion, overlays, pickers, transitions, or animation library choice.
