...
Load `skills/engineering/SKILL.md` first. Load `skills/reviewer/SKILL.md` when you need project-convention context to judge a thread.
...
1. **Commit** — follow `skills/ci-commit/SKILL.md` (change-tier review). Scoped consent from Step 3 applies.
2. **Push** — follow `skills/ci-push/SKILL.md` (PR-tier review), then `git push -u origin HEAD` if needed. Scoped consent from Step 3 applies.
