...
Language-agnostic rules for writing tests. Runner and library specifics live on the matching language skill (`code/languages/python` → `references/testing.md`, `code/languages/nodejs` → `references/testing.md`).
