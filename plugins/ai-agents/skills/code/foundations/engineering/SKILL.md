...
Language-agnostic principles that every `code/**` skill assumes and extends. This skill owns the *why* of good code; downstream skills (`languages/nodejs`, `languages/python`, `languages/cpp`, `web/ui`, `web/libs/*`, `games/unreal`, `quality/*`) own the *how* for their domain. Do not restate language syntax or framework rules here.
