...
Every code skill opens with an `## Extends` section pointing here and must not contradict these principles. It may add stricter, domain-specific rules. Project skills under `project/` may tighten rules further, never loosen them.
