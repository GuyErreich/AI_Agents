...
Load `skills/engineering/SKILL.md` and `skills/ui/SKILL.md` first (reuse, primitives, semantic elements). For React components, also load `skills/react/SKILL.md` when hooks or animation cleanup apply.
