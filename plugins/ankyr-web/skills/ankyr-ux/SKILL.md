---
name: ankyr-ux
description: Web UX — tactile feedback, motion, overlays, pickers, generative sound, and library choice for interactive surfaces. Use when adding buttons, sheets, tabs, transitions, pickers, or choosing animation/overlay libraries.
disable-model-invocation: true
---

# Web UX

Behavior, motion, and interactivity quality for web UIs. Generic structure and accessibility semantics live in `ui`; this skill covers **how interactions feel** and **which tools implement them**.

## Foundation

Resolve standards project-first (`AGENT.md` chain, project rules, project skills, then this plugin if installed). Preferred order if installed: engineering and ui first (reuse, primitives, semantic elements), then react when hooks or animation cleanup apply.
